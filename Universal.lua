...
UniversalMenu.AutoFarm:Boolean("Q1", "AutoQ1", false)
UniversalMenu.AutoFarm:Boolean("Q2", "AutoQ2", false)
UniversalMenu.AutoFarm:Boolean("Q3", "AutoQ3", false)
UniversalMenu.AutoFarm:Boolean("Q4", "AutoQ4", false)
UniversalMenu.AutoFarm:Boolean("", "")


UniversalMenu.AutoFarm:Boolean("W1", "AutoW1", false)
UniversalMenu.AutoFarm:Boolean("W2", "AutoW2", false)
UniversalMenu.AutoFarm:Boolean("W3", "AutoW3", false)
UniversalMenu.AutoFarm:Boolean("W4", "AutoW4", false)
UniversalMenu.AutoFarm:Boolean("", "")


UniversalMenu.AutoFarm:Boolean("E1", "AutoE1", false)
UniversalMenu.AutoFarm:Boolean("E2", "AutoE2", false)
UniversalMenu.AutoFarm:Boolean("E3", "AutoE3", false)
UniversalMenu.AutoFarm:Boolean("E4", "AutoE4", false)
UniversalMenu.AutoFarm:Boolean("", "")


UniversalMenu:SubMenu("LaneClear", "LaneClear")
UniversalMenu.LaneClear:Boolean("Q1", "Use Q1", false)
UniversalMenu.LaneClear:Boolean("Q2", "Use Q2", false)
UniversalMenu.LaneClear:Boolean("Q3", "Use Q3", false)
UniversalMenu.LaneClear:Boolean("Q4", "Use Q4", false)
UniversalMenu.LaneClear:Boolean("", "")

UniversalMenu.LaneClear:Boolean("W1", "Use W1", false)
UniversalMenu.LaneClear:Boolean("W2", "Use W2", false)
UniversalMenu.LaneClear:Boolean("W3", "Use W3", false)
UniversalMenu.LaneClear:Boolean("W4", "Use W4", false)
UniversalMenu.LaneClear:Boolean("", "")

UniversalMenu.LaneClear:Boolean("E1", "Use E1", false)
UniversalMenu.LaneClear:Boolean("E2", "Use E2", false)
UniversalMenu.LaneClear:Boolean("E3", "Use E3", false)
...
UniversalMenu.KillSteal:Boolean("Q1", "KS w Q1", false)
UniversalMenu.KillSteal:Boolean("Q2", "KS w Q2", false)
UniversalMenu.KillSteal:Boolean("Q3", "KS w Q3", false)
UniversalMenu.KillSteal:Boolean("Q4", "KS w Q4", false)
UniversalMenu.KillSteal:Boolean("", "")

UniversalMenu.KillSteal:Boolean("W1", "KS w W1", false)
UniversalMenu.KillSteal:Boolean("W2", "KS w W2", false)
UniversalMenu.KillSteal:Boolean("W3", "KS w W3", false)
UniversalMenu.KillSteal:Boolean("W4", "KS w W4", false)
UniversalMenu.KillSteal:Boolean("", "")


UniversalMenu.KillSteal:Boolean("E1", "KS w E1", false)
UniversalMenu.KillSteal:Boolean("E2", "KS w E2", false)
UniversalMenu.KillSteal:Boolean("E3", "KS w E3", false)
UniversalMenu.KillSteal:Boolean("E4", "KS w E4", false)
UniversalMenu.KillSteal:Boolean("", "")

UniversalMenu.KillSteal:Boolean("R1", "KS w R1", false)
UniversalMenu.KillSteal:Boolean("R2", "KS w R2", false)
UniversalMenu.KillSteal:Boolean("R3", "KS w R3", false)
UniversalMenu.KillSteal:Boolean("R4", "KS w R4", false)
